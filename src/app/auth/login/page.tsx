// src/app/freelancer/login/page.tsx
'use client';
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-white overflow-y-auto">
                <div className="w-full max-w-md py-4">
                    ...
                    <div className="text-center mb-6 lg:mb-8">
                                ...
                                >
                                    <div className="flex items-center justify-center space-x-2">
                                        <input
                                            ...
                                            className="w-4 h-4 text-blue-600 border border-gray-400 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        />
                        ...
                        <div className="text-center mb-6 lg:mb-8">
                            <h2 className="text-base lg:text-lg font-semibold text-gray-900 mb-2">Welcome Back</h2>
                            <p className="text-gray-900 text-xl lg:text-2xl font-black">Login Account</p>
                        </div>
                    </div>

                    {/* Social Login - PREND TOUTE LA LARGEUR */}
                    <div className="w-full mb-4 lg:mb-6">
                        <div className="flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 w-full">
                            <button className="flex items-center justify-center space-x-2 border border-gray-300 rounded-lg px-3 py-2 lg:px-4 lg:py-3 hover:border-blue-500 hover:bg-gray-50 transition-colors shadow-sm flex-1 w-full">
                                <svg className="w-4 h-4 lg:w-5 lg:h-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <button className="flex items-center justify-center space-x-2 border border-gray-300 rounded-lg px-3 py-2 lg:px-4 lg:py-3 hover:border-blue-800 hover:bg-gray-50 transition-colors shadow-sm flex-1 w-full">
                                <svg className="w-4 h-4 lg:w-5 lg:h-5 text-blue-800" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <form className="space-y-4 lg:space-y-6 w-full">
                        ...
                        <div className="w-full">
                            ...
                            <input
                                type="text"
                                className="w-full px-3 lg:px-4 py-2 lg:py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors bg-white text-gray-900 text-sm placeholder-gray-500"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0 mb-4 lg:mb-6 w-full">
                            <div className="flex items-center">
                                <input
                                    ...
                                    className="w-4 h-4 text-blue-600 border-2 border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                                <label htmlFor="remember" className="ml-2 text-xs lg:text-sm text-gray-900 font-bold">
                                    Remember Me
                                </label>
                            </div>
                            <Link
                                href="/forgot-password"
                                className="text-xs lg:text-sm text-blue-600 hover:text-blue-800 transition-colors font-bold text-right"
                            >
                                Forgot password?
                            </Link>
                        </div>
                        ...
                        {/* Login Button avec couleur #001454 */}
                        <button
                            type="submit"
                            className="w-full bg-[#001454] text-white py-3 lg:py-4 px-4 rounded-lg font-bold text-base lg:text-lg hover:bg-[#001454]/90 focus:ring-2 focus:ring-[#001454] focus:ring-offset-2 transition-colors shadow-md"
                        >
                            Login Account
                        </button>
                    </form>
